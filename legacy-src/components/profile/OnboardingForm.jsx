...
export default function OnboardingForm({ userId, onComplete }) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-slate-50 to-teal-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Welcome to TaxPilot NG</h1>
                    ...
                    {[
                      ...
                      <div
                        ...
                        className={`flex items-center justify-between p-4 rounded-xl border-2 transition-all ${
                          formData[field] ? 'border-emerald-300 bg-emerald-50 dark:bg-emerald-900/10' : 'border-slate-200 dark:border-slate-700'
                        }`}
                      >
